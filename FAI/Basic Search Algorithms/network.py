...
class Network():
    ...
    def __init__(self, amount_of_nodes, branching_factor, seed = 0, costs = [1],
        ...
        probability_connection = amount_of_connections / amount_of_costs
        ...
        if not cost_probabilities:
            ...
            probability_each_cost = probability_connection / len(costs)

            # creating a list of probabilities of each cost + prob. of no connection NA (the first element in the list)
            probabilities = [1 - probability_connection] + [probability_each_cost] * len(costs)
        else:
            ...
            probabilities = [1 - probability_connection] + cost_probabilities
        ...
        if secure_path_to_goal:
            ...
            goal_path = random.sample(range(1, amount_of_nodes - 1), 
                                      random.randint(1, amount_of_nodes-2))
            ...
            # overwrite cost matrix with the costs of the goal path
